...
{
    /// <summary>
	///     Converts a object of type <see cref="UserRoles" /> to an appropriate string representation and vice versa
	/// </summary>
	public class StringUserRoleConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (valueString != null)
            {
                return Authorization.Authorization.AuthenticationService.RolesList.FirstOrDefault(item => item.Name == valueString);
            }
