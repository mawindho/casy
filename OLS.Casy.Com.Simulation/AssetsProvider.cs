...
{
    /// <summary>
    /// Implementation of <see cref="IAssetsProvider"/> to provide assets defined in the OLS.Casy.Com.Simulation assembly 
    /// </summary>
    ...
    public class AssetsProvider : IAssetsProvider
    {
        ...
        public IEnumerable<string> AssetUris
        {
            get
            {
                return new[]
                    {
                        @"pack://application:,,,/OLS.Casy.Ui.MainControls;component\Assets\ViewModelViewMappings.xaml"
