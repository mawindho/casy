...
namespace OLS.Casy.ActivationServer.ReportGenerator
{
    public class FileSystemStorageService : IFileSystemStorageService, IDisposable
    {
        ...
        public FileSystemStorageService(ILogger<FileSystemStorageService> logger)
        {
        ...
        public async Task<bool> DeleteDirectoryAsync(string sourcePath, bool recursive)
        {
            ...
            {
                this._logger.LogError($"Error while deleting '{sourcePath}'\n{e.Message}");
                return false;
            }
        }
        ...
        public async Task<bool> CreateDirectoryAsync(string name)
        {
            ...
            {
                this._logger.LogError($"Error while creating the directory '{name}'\n{e.Message}");
                return false;
            }
        ...
        private void CreateRetry(FileSystemTask task)
        {
            ...
            this._logger.LogDebug("Exception occured while file system task execution. Retry #" + task.RetryCount);
