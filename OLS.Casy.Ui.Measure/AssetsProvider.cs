...
namespace OLS.Casy.Ui.Measure
{
    /// <summary>
    /// Implementation of <see cref="IAssetsProvider"/> to provide assets defined in the OLS.Casy.Ui.Measure assembly 
    /// </summary>
    ...
    public class AssetsProvider : IAssetsProvider
    {
        ...
        public IEnumerable<string> AssetUris
        {
            get
            {
                return new[]
                    {
                        @"pack://application:,,,/OLS.Casy.Ui.Measure;component\Assets\ViewModelViewMappings.xaml"
                    };
            }
        }
