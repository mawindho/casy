...
namespace OLS.Casy.Ui.Core.ViewModels
{
    ...
    public class OverlayDocumentSettingsViewModel : ViewModelBase, ISettingsCategoryViewModel, IPartImportsSatisfiedNotification
    {
        ...
        public OverlayDocumentSettingsViewModel(
        ...
        public int Order => 3;
        public string Name => _localizationService.GetLocalizedString("OverlayDocumentSettingsViewModel_Title");
        ...
        {
            _documentSettingsManager.LoadDocumentSettings(DocumentType.Overlay);
            _availableDocumentSectionParameterViewModels.Clear();
            foreach (var documentSetting in _documentSettingsManager.OverlayDocumentSettings)
            {
        ...
        public void OnOk()
        {
            _documentSettingsManager.SaveDocumentSettings(DocumentType.Overlay);
        }
