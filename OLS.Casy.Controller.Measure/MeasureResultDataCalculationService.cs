...
namespace OLS.Casy.Controller.Measure
{
    ...
    [Export(typeof(IMeasureResultDataCalculationService))]
    public class MeasureResultDataCalculationService : IMeasureResultDataCalculationService
    {
        private readonly IVolumeCalculationProvider _volumeCalculationProvider;
        //private readonly object _lock = new object();

        [ImportingConstructor]
        public MeasureResultDataCalculationService(IVolumeCalculationProvider volumeCalculationProvider)
        {
        ...
        public async Task UpdateMeanDeviationsAsync(MeasureResult meanMeasureResult, MeasureResult[] measureResults)
        {
            ...
            {
                measureResultItems.AddRange(await GetMeasureResultDataAsync(measureResult, meanMeasureResult.MeasureSetup));
            }
        ...
        private static void UpdateMeasureResultItem(MeasureResult measureResult, MeasureResultItem measureResultItemParam)
        {
            ...
            else
            {
                ...
                if(measureResultItem == null)
                {
                    measureResult.MeasureResultItemsContainers[measureResultItemParam.MeasureResultItemType].CursorItems.Add(measureResultItemParam);
        ...
        private void CreateMultiCursorResult(ref List<MeasureResultItem> result, MeasureResult measureResult, IReadOnlyList<Cursor> cursors, MeasureResultItemTypes itemType, IReadOnlyList<double> values, bool updateMeasureResultItems)
        {
